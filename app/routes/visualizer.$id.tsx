...
import {Download, PencilRuler, RefreshCcw, X} from "lucide-react";
...
const VisualizerId = () => {
    ...
    const {initialImage,initialRender, name} = (location.state as { initialImage?: string, initialRender?: string | null, name?: string }) || {};
